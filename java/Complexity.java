...
public class Complexity 
{
  ...
  public interface ITestRun {
      ...
      public void teardown(Object state) throws Exception;
  }
  ...
  public static long measure(boolean cleanRuntime, int iterations, String setupCommand, String runCommand, String teardownCommand) throws Exception
  {
    ...
    if(teardownCommand != null && !teardownCommand.isEmpty()) cc.getDeclaredMethod("teardown").setBody(teardownCommand); 
